  ...
  private async seedAccessPolicies() {
    ...
    if (res.rows.length === 0) {
      const initialPolicies = [
        // Student
        { role: "student", resource: "course_materials", permission: "read", allowed: true },
        { role: "student", resource: "course_materials", permission: "download", allowed: true },
        { role: "student", resource: "assignments", permission: "read", allowed: true },
        { role: "student", resource: "assignments", permission: "submit", allowed: true },
        { role: "student", resource: "grades", permission: "read", allowed: true },

        // Faculty
        { role: "faculty", resource: "course_materials", permission: "read", allowed: true },
        { role: "faculty", resource: "course_materials", permission: "write", allowed: true },
        { role: "faculty", resource: "course_materials", permission: "upload", allowed: true },
        { role: "faculty", resource: "course_materials", permission: "delete", allowed: true },
        { role: "faculty", resource: "assignments", permission: "read", allowed: true },
        { role: "faculty", resource: "assignments", permission: "write", allowed: true },
        { role: "faculty", resource: "assignments", permission: "grade", allowed: true },
        { role: "faculty", resource: "assignments", permission: "delete", allowed: true },
        { role: "faculty", resource: "grades", permission: "read", allowed: true },
        { role: "faculty", resource: "grades", permission: "write", allowed: true },
        { role: "faculty", resource: "grades", permission: "manage", allowed: true },
        { role: "faculty", resource: "user_database", permission: "read", allowed: true },

        // Admin
        { role: "admin", resource: "course_materials", permission: "read", allowed: true },
        { role: "admin", resource: "course_materials", permission: "write", allowed: true },
        { role: "admin", resource: "course_materials", permission: "upload", allowed: true },
        { role: "admin", resource: "course_materials", permission: "delete", allowed: true },
        { role: "admin", resource: "assignments", permission: "read", allowed: true },
        { role: "admin", resource: "assignments", permission: "write", allowed: true },
        { role: "admin", resource: "assignments", permission: "grade", allowed: true },
        { role: "admin", resource: "assignments", permission: "delete", allowed: true },
        { role: "admin", resource: "grades", permission: "read", allowed: true },
        { role: "admin", resource: "grades", permission: "write", allowed: true },
        { role: "admin", resource: "grades", permission: "manage", allowed: true },
        { role: "admin", resource: "user_database", permission: "read", allowed: true },
        { role: "admin", resource: "user_database", permission: "write", allowed: true },
        { role: "admin", resource: "user_database", permission: "manage", allowed: true },
        { role: "admin", resource: "user_database", permission: "delete", allowed: true },
        { role: "admin", resource: "system_settings", permission: "read", allowed: true },
        { role: "admin", resource: "system_settings", permission: "write", allowed: true },
        { role: "admin", resource: "system_settings", permission: "manage", allowed: true },

        // Guest Role
        { role: "guest", resource: "course_materials", permission: "read", allowed: true },
        { role: "guest", resource: "assignments", permission: "read", allowed: false },
        { role: "guest", resource: "grades", permission: "read", allowed: false },

        // Security Resource
        { role: "admin", resource: "security_logs", permission: "read", allowed: true },
        { role: "admin", resource: "security_logs", permission: "delete", allowed: true },
        { role: "faculty", resource: "security_logs", permission: "read", allowed: true },
        { role: "student", resource: "security_logs", permission: "read", allowed: false },
      ];
